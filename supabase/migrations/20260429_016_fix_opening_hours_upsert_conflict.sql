-- LocalFood — Fix ambiguous restaurant_id reference in opening hours upsert RPC
-- Purpose:
-- Use the named unique constraint instead of ON CONFLICT column list to avoid PL/pgSQL ambiguity.
