...
const NAV: NavItem[] = [
  ...
  { to: "/restaurant-dashboard/opening-hours", labelKey: "admin.layout.openingHours", icon: Clock },
  { to: "/restaurant-dashboard/offers", labelKey: "admin.layout.offers", icon: BadgePercent },
